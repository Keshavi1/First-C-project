...
/**
    This is a small project that i used mainly to learn c. You're able to make a list for elements and save it to a .txt file.
    You can also open a .txt file. You can mess around with this for a bit if you want. 
*/
